...
public class FindElements2 {
    public static void main(String[] args) {
        ...
        driver.get("https://www.w3.org/TR/2019/NOTE-wai-aria-practices-1.1-" +
                "20190814/examples/checkbox/checkbox-1/checkbox-1.html");
       ...
       // System.out.println(googlebutton.getText());
